                    ...
                    <div class="tile is-ancestor has-text-centered">
                        <div class="tile is-parent is-2">
                            <article class="tile is-child box" style="background-color: #A6E3E9;">
                                ...
                                <p class="subtitle">นักศึกษาที่สำเร็จการฝึกงาน/สหกิจศึกษา</p>
                            </article>
                        </div>
                        <div class="tile is-parent is-2">
                        ...
                        <div class="tile is-parent is-2">
                            <article class="tile is-child box" style="background-color: #FFBFBF;">
                                ...
                                <p class="subtitle">ยังไม่กรอกข้อมูล</p>
                            </article>
                        </div>
  ...
  <div class="box mb-3">
    <div class="table-container">
      <table class="table is-striped is-fullwidth is-size-7">
        ...
        <tbody>
          <tr v-for="(student, index) in computedFilteredApplications" :key="student.benefit_id">
            ...
            <td>{{ student.benefit_status}}</td>
                        <td class="pl-6 pt-5 pb-1">
              <button class="button is-info" @click="viewBenefitDetails(student.benefit_id)">
           ดูรายละเอียด
              </button>
            </td>
          </tr>
...
methods: {
  ...
  getStudentLists(){
    ...
    const config = {
     ...
     axios
      .get(`${backendUrl}/admin/BenefitList`, config)
      .then((response) => {
  ...
  getstudentsWithoutApplications(){
    ...
    const config = {
     ...
     axios
      .get(`${backendUrl}/admin/students/without-applications`, config)
      .then((response) => {
